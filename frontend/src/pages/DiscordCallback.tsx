  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 p-4">
        ...
        >
          <Card className="bg-dark-800/80 backdrop-blur-lg border-red-500/30">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800">
      ...
      >
        ...
        <p className="text-dark-400 mb-8">Завершаем процесс авторизации и настраиваем ваш профиль...</p>
        ...
        <div className="space-y-4 max-w-md mx-auto">
          ...
          <div className="flex items-center space-x-3 p-3 bg-dark-800/50 rounded-lg opacity-50">
